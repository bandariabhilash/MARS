...
namespace FBCall.Models
{
    public class WorkOrderManagementEquipmentModel
    {
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipment workOrderEquipment, NewcoEntity NewcoEntity)
        {
            ...
            IQueryable<WorkorderPart> workOrderParts = NewcoEntity.WorkorderParts.Where(wp => wp.AssetID == AssetId);
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipmentRequested workOrderEquipment, NewcoEntity NewcoEntity)
        {
            Manufacturer = workOrderEquipment.Manufacturer;
            Solution = workOrderEquipment.Solutionid;
            Temperature = workOrderEquipment.Temperature;
