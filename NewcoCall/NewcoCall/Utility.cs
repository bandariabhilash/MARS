...
namespace NewcoCall
{
    public class Utility
    {
        ...
        public static IList<UserType> GetUserType(NewcoEntity NewcoEntity)
        {
            IList<UserType> userType = NewcoEntity.UserTypes.ToList();
        ...
        public static IList<State> GetStates(NewcoEntity ReviveEntitites)
        {
        ...
        public static ZonePriority GetCustomerZonePriority(NewcoEntity NewcoEntity, string zipCode)
        {
            ZonePriority zonePriority = null;
            ZoneZip zonezip = NewcoEntity.ZoneZips.FirstOrDefault(z => z.ZipCode == zipCode.Substring(0, 5));
            if (zonezip != null)
            {
                zonePriority = NewcoEntity.ZonePriorities.FirstOrDefault(zp => zp.ZoneIndex == zonezip.ZoneIndex);
            }
            return zonePriority;
        }

        public static string GetCustomerTimeZone(string zipCode, NewcoEntity NewcoEntity)
        {
            if (zipCode.Length > 5)
            {
            ...
            Zip zip = NewcoEntity.Zips.Where(z => z.ZIP1 == zipCode).FirstOrDefault();
            if (zip != null)
            {
        ...
        public static IndexCounter GetIndexCounter(string indexName, int countValue)
        {
            ...
            using (NewcoEntity newEntity = new NewcoEntity())
            {
        ...
        public static DateTime GetCurrentTime(string zipCode, NewcoEntity ReviveEntity)
        {
        ...
        public static PricingDetail GetPricingDetails(string PricingParentID, int? TechId, string CustomerState, NewcoEntity FarmerBrothersEntitites)
        {
