...
namespace FetcoCall.Models
{
    public class CustomerModel
    {
        ...
        {
            using (FetcoEntities entities = new FetcoEntities())
            {
        ...
        public CustomerModel(WorkOrder workOrder, FetcoEntities FarmerBrothersEntitites)
        {
        ...
        public void CreateUnknownCustomer(CustomerModel CustModel, FetcoEntities FBE)
        {
        ...
        public static int GetCallsTotalCount(FetcoEntities FBE, string CustomerID)
        {
        ...
        public static string GetServiceLevelDesc(FetcoEntities FBE, string BillingCode)
        {
            string Description = "";
        ...
        public static void InsertCustomerData(List<CustomerModel> customerList, FetcoEntities fileUploadEntity)
        {
