...
namespace FetcoCall.Models
{
    public class WorkorderManagementModel
    {
        ...
        public WorkOrder FillCustomerData(WorkOrder entityWorkOrder, bool cleanDependentLists, FetcoEntities FetcoServiceEntities, CustomerModel customerdata, Contact sCustomer = null)
        {
            ...
            ZonePriority zonePriority = Utility.GetCustomerZonePriority(FetcoServiceEntities, customerdata.ZipCode);
            ...
            if (!string.IsNullOrEmpty(entityWorkOrder.CustomerZipCode))
            {
                ...
                Zip zip = FetcoServiceEntities.Zips.Where(z => z.ZIP1 == customerZip).FirstOrDefault();
