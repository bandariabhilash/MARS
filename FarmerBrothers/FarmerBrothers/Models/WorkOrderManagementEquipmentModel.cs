...
namespace FarmerBrothers.Models
{
    public class WorkOrderManagementEquipmentModel
    {
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipment workOrderEquipment, FarmerBrothersEntities FormalBrothersEntities)
        {
        ...
        public WorkOrderManagementEquipmentModel(WorkorderEquipmentRequested workOrderEquipment, FarmerBrothersEntities FarmerBrothersEntities)
        {
            Manufacturer = workOrderEquipment.Manufacturer;
            Solution = workOrderEquipment.Solutionid;
            Temperature = workOrderEquipment.Temperature;
