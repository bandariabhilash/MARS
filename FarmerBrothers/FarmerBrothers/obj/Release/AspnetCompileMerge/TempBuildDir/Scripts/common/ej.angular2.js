    ...
    return {
        ...
        execute: function() {
            ...
            exports_7("PointDirective", PointDirective = core_8.CreateComplexDirective({
                ...
                inputs: ["border", "showIntermediateSum", "showTotalSum", "close", "size", "fill", "high", "low", "marker", "open", "text", "x", "y"],
                queries: {}
            }, {
                tags: [],
                type: core_8.forwardRef(function () { return ChartComponent; })
...
System.register("ej/circulargauge.component", ["ej/core"], function(exports_9, context_9) {
    ...
    return {
        ...
        execute: function() {
            ...
            Inputs = core_10.Utils.AngularizeInputs(["animationSpeed", "backgroundColor", "distanceFromCorner", "enableAnimation", "enableResize", "frame", "gaugePosition", "height", "interiorGradient", "isRadialGradient", "outerCustomLabelPosition", "radius", "readOnly", "scales", "theme", "tooltip", "width", "frame.backgroundImageUrl", "frame.frameType", "frame.halfCircleFrameEndAngle", "frame.halfCircleFrameStartAngle", "scales.backgroundColor", "scales.border", "scales.border.color", "scales.border.width", "scales.direction", "scales.majorIntervalValue", "scales.maximum", "scales.minimum", "scales.minorIntervalValue", "scales.opacity", "scales.pointerCap", "scales.pointerCap.backgroundColor", "scales.pointerCap.borderColor", "scales.pointerCap.borderWidth", "scales.pointerCap.interiorGradient", "scales.pointerCap.radius", "scales.radius", "scales.shadowOffset", "scales.showIndicators", "scales.showLabels", "scales.showPointers", "scales.showRanges", "scales.showScaleBar", "scales.showTicks", "scales.size", "scales.startAngle", "scales.sweepAngle", "tooltip.showCustomLabelTooltip", "tooltip.showLabelTooltip", "tooltip.templateID", "scales.indicators", "scales.labels", "scales.pointers", "scales.ranges", "scales.subGauges", "scales.ticks"], ["value", "minimum", "maximum"]);
...
System.register("ej/kanban.component", ["ej/core"], function(exports_20, context_20) {
    ...
    return {
        ...
        execute: function() {
            ...
            ComplexProperties = ["swimlaneSettings", "contextMenuSettings", "cardSettings", "editSettings", "fields", "keySettings", "searchSettings", "tooltipSettings"];
            Inputs = core_21.Utils.AngularizeInputs(["allowDragAndDrop", "allowTitle", "swimlaneSettings", "allowToggleColumn", "allowSearching", "allowSelection", "allowHover", "allowKeyboardNavigation", "allowScrolling", "contextMenuSettings", "cardSettings", "cssClass", "enableRTL", "enableTotalCount", "enableHover", "editSettings", "fields", "keyField", "isResponsive", "minWidth", "primaryKeyField", "query", "keySettings", "scrollSettings", "searchSettings", "selectionType", "tooltipSettings", "locale", "swimlaneSettings.showCount", "contextMenuSettings.enable", "contextMenuSettings.disableDefaultItems", "cardSettings.template", "cardSettings.colorMapping", "editSettings.allowEditing", "editSettings.allowAdding", "editSettings.dialogTemplate", "editSettings.editMode", "fields.primaryKey", "fields.swimlaneKey", "fields.priority", "fields.content", "fields.tag", "fields.title", "fields.color", "fields.imageUrl", "keySettings.focus", "keySettings.insertCard", "keySettings.deleteCard", "keySettings.editCard", "keySettings.saveRequest", "keySettings.cancelRequest", "keySettings.firstCardSelection", "keySettings.lastCardSelection", "keySettings.upArrow", "keySettings.downArrow", "keySettings.rightArrow", "keySettings.leftArrow", "keySettings.swimlaneExpandAll", "keySettings.swimlaneCollapseAll", "keySettings.selectedGroupExpand", "keySettings.selectedGroupCollapse", "keySettings.selectedColumnCollapse", "keySettings.selectedColumnExpand", "keySettings.multiSelectionByUpArrow", "keySettings.multiSelectionByLeftArrow", "keySettings.multiSelectionByRightArrow", "searchSettings.fields", "searchSettings.key", "searchSettings.operator", "searchSettings.ignoreCase", "tooltipSettings.enable", "tooltipSettings.template", "columns", "filterSettings", "stackedHeaderRows", "contextMenuSettings.customMenuItems", "editSettings.editItems"], ["dataSource"]);
...
System.register("ej/listbox.component", ["ej/core"], function(exports_22, context_22) {
    ...
    return {
        ...
        execute: function() {
            ...
            ComplexProperties = [];
            Inputs = core_23.Utils.AngularizeInputs(["allowDrag", "allowDrop", "allowMultiSelection", "allowVirtualScrolling", "caseSensitiveSearch", "cascadeTo", "checkedIndices", "cssClass", "dataSource", "enabled", "enableIncrementalSearch", "enablePersistence", "enableRTL", "fields", "height", "itemsCount", "totalItemsCount", "itemRequestCount", "loadDataOnInit", "query", "selectedIndex", "showCheckbox", "showRoundedCorner", "template", "virtualScrollMode", "width", "targetID"], ["value"]);
...
System.register("ej/radialmenu.component", ["ej/core"], function(exports_31, context_31) {
    ...
    return {
        ...
        execute: function() {
            Outputs = ["mouseDown", "mouseUp", "select"];
            ComplexProperties = [];
            Inputs = core_32.Utils.AngularizeInputs(["autoOpen", "backImageClass", "cssClass", "enableAnimation", "imageClass", "radius", "targetElementId"], []);
...
System.register("ej/spreadsheet.component", ["ej/core"], function(exports_43, context_43) {
    ...
    return {
        ...
        execute: function() {
            ...
            Outputs = ["actionBegin", "actionComplete", "autoFillBegin", "autoFillComplete", "beforeCellFormat", "beforeCellSelect", "beforeDrop", "beforeOpen", "beforePanelOpen", "cellClick", "cellEdit", "cellHover", "cellSave", "contextMenuClick", "drag", "dragStart", "drop", "editRangeBegin", "editRangeComplete", "load", "loadComplete", "menuClick", "openFailure", "pagerClick", "ribbonClick", "seriesRendering", "tabClick", "tabSelect"];
...
System.register("ej/tileview.component", ["ej/core"], function(exports_46, context_46) {
    ...
    return {
        ...
        execute: function() {
            ...
            ComplexProperties = ["badge", "livetile"];
            Inputs = core_47.Utils.AngularizeInputs(["badge", "captionTemplateId", "cssClass", "enablePersistence", "height", "imageClass", "imagePosition", "imageTemplateId", "imageUrl", "livetile", "showText", "text", "textAlignment", "tileSize", "width", "showRoundedCorner", "allowSelection", "backgroundColor", "badge.enabled", "badge.maxValue", "badge.minValue", "badge.text", "badge.value", "badge.position", "livetile.enabled", "livetile.imageClass", "livetile.imageTemplateId", "livetile.imageUrl", "livetile.type", "livetile.updateInterval", "livetile.text"], []);
