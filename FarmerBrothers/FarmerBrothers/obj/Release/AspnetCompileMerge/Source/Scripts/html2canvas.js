...
(function (window, document, exports, global, define, undefined) {
    ...
    window.html2canvas = function (nodeList, options) {
        ...
        //node.ownerDocument.defaultView.innerWidth, node.ownerDocument.defaultView.innerHeight;
        return renderDocument(node.ownerDocument, options, 1600, 1200, index).then(function (canvas) {
    ...
    function renderWindow(node, container, options, windowWidth, windowHeight) {
        ...
        var renderer = new options.renderer(1800, height, imageLoader, options, document);
    ...
    NodeParser.prototype.paintText = function (container) {
        ...
        try {
            var sizeNum = size.substr(0, 2);
            var sizeNumInt = parseInt(sizeNum) + 5
            size = sizeNumInt + "px";
        }
        catch (e) {
        }
